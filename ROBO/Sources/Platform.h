...
#define PL_TARGET_BOARD K22FXROBO ///*Sets the current platform
...
///* is active.
	...
	///*The ROBO Board has a Trigger

	#define PL_HAS_MEALY (1)
	///*The ROBO Board has Mealy capability
	...
	///*Deactivates Debouncing capabilities

	#define PL_HAS_TRIGGER (0)
	///*Deactivates Trigger Capabilities

	#define PL_HAS_MEALY (0)
	///*Deactivates Mealy capability
